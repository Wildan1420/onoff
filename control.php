        ...
        <div class="row">
            <div class="col-3">
                <ul class="list-group mt-4 ">
                    <li class="list-group-item text-dark p-3"><h3>Control</h3></li>
                    ...
                    <a href="?page=lightroom" class="list-group-item text-dark list-menu-custom my-2
                        <?php echo isset($_GET['page']) && $_GET['page'] == 'lightroom' ? 'active' : ''  ?>">Lightroom</a>
                    <a href="?page=plugroom" class="list-group-item text-dark list-menu-custom my-2 
                    ...
                    <!-- <a href="?page=setting" class="list-group-item text-dark list-menu-custom 
                        <?php echo isset($_GET['page']) && $_GET['page'] == 'setting' ? 'active' : ''  ?>">Setting</a> -->
                    <a href="index.php?logout='1'" class="list-group-item text-dark list-menu-custom my-2">Log out</a>
                </ul>
            </div>
            <div class="col-9">
                <div class="row">
