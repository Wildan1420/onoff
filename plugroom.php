                ...
                <div class="result_box" style="padding-top:5px">
                    ...
                    <form method="post">
                        ...
                        <div style="padding-top:10px;">
                            <button class="btn btn-success rounded mx-5 " ng-click="checkplug1(1)" id="sw1on"
                                name="sw1on" type="button">ON</button>
                            <button class="btn btn-danger rounded mx-5" ng-click="checkplug1(0)" id="sw1off"
            ...
            <div class="plug2">
                ...
                <div class="result_box" style="padding-top:5px">
                    ...
                    <form method="post">
                        <div class="box on"></div>
                        <div style="padding-top:10px;">
                            <button class="btn btn-success rounded mx-5 " ng-click="checkplug2(1)" id="sw2on"
                                name="sw2on" type="button">ON</button>
                            <button class="btn btn-danger rounded mx-5" ng-click="checkplug2(0)" id="sw2off"
            ...
            <div class="plug3">
                ...
                <div class="result_box" style="padding-top:5px">
                    ...
                    <form method="post">
                        <div class="box on"></div>
                        <div style="padding-top:10px;">
                            <button class="btn btn-success rounded mx-5 " ng-click="checkplug3(1)" id="sw3on"
                                name="sw3on" type="button">ON</button>
                            <button class="btn btn-danger rounded mx-5" ng-click="checkplug3(0)" id="sw3off"
