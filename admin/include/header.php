                    ...
                    <div class="app-utilities col-auto">
                        ...
                        <div class="app-utility-item app-user-dropdown dropdown">
                            ...
                            href="#" role="button" aria-expanded="false">
                                <img class ="rounded-circle mr-1"src="upload/admin/<?=$_SESSION['image_login']?>" alt="user profile" >
                            <?=$_SESSION['username_login']?></a>
    ...
    <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="../admin/"><img class="logo-icon me-2" src="upload/custom/logo2.jpg" alt="logo" />
                <span class="logo-text">System</span></a>
            </div>
            <!--//app-branding-->
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'product' ? 'active' : ''  ?>" 
                        href="?page=product">
                            <span class="nav-icon">
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'admin' ? 'active' : ''  ?>" 
                        href="?page=admin">
                            <span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
